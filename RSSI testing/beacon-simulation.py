...
API_KEY = "1ea3680f53a83b4840c2039b28588f02"  # Replace with your actual API key
...
HUBS_CONFIG = [
    {
        ...
        'hubId': 'hub88488866',
        'zone': 'Zone1',
        'interval': 5.0,  # Send every 5 second
        'rssi_range': (-46, -36)  # Customize RSSI range for this hub
    },
    {
        'name': 'Kuhlraum 7',
        'hubId': 'hub1323B3540',
        'zone': 'Zone1',
        'interval': 5.0,  # Send every 5 second
        'rssi_range': (-39, -29)  # Slightly different RSSI range
    },
    # {
    #     'name': 'Embedded',
    #     'hubId': 'hub869B3540',
    #     'zone': 'Zone2',
    #     'interval': 3.0,  # Send every 1 second
    #     'rssi_range': (-40, -40)  # Weaker signal in different zone
    # }
]
